...
public class PageRank {
	...
	static String FILE_FOR_PERPLEXITY="perplexity.txt";
	static String FILE_FOR_PAGE_RANK="pagerank.txt";
	static String FILE_FOR_PAGE_WITH_IN_LINKS="inlink.txt";
	static String FILE_FOR_PROPORTION="proportions.txt";
	static String FILE_FOR_EACH_RANK="ranks.txt";
	
	static String FILE_AFTER_1="PR_after_1.txt";
	static String FILE_AFTER_10="PR_after_10.txt";
	static String FILE_AFTER_100="PR_after_100.txt";
	...
	public static void parseData() throws Exception
	{
		...
		try
		{
			if(evaluationType==0)
			{
				fs=new FileInputStream(new File("src/com/pagerank/test_graph.txt"));
			}
			else if(evaluationType==1)
			{
				fs=new FileInputStream(new File("src/com/pagerank/test_WT2g.txt"));
			}
	...
	public static void main(String arg[]) throws Exception
	{
		...
		evaluationType=Integer.parseInt(arg[0]);
		parseData();
		setSinkNodes();
		setInitialPR();
		//*********************************
		...
		if(evaluationType==1)
		{
		listOfPerplexityValues();
		listOfPagesByPageRank();
		listOfPagesByInLink();
		propData();
		}
	}
	...
	private static void writePageRank(int itr,String fileName) throws Exception
	{
		...
		for(Entry<String,List<Double>> rank:pageRank.entrySet())
		{
			...
			prSum+=rank.getValue().get(1);
			buffer.append(rank);
			buffer.append(System.getProperty("line.separator"));
		}
		buffer.append("***************************************************************************");
		buffer.append(System.getProperty("line.separator"));
		buffer.append("prSum::"+prSum+"::"+itr);
		buffer.append(System.getProperty("line.separator"));
		buffer.append(System.getProperty("line.separator"));
		}
	...
	public static void processNextPageRank() throws Exception
	{
		...
		while(check)
		{
			...
			//writePageRank(counter);
			System.out.println("sinkPR::"+sinkPR);
			System.out.println("iteration::"+counter);
			if(evaluationType==1)
			{
				perplexity.add(calculatePerplexity());
